  ...
  return (
    <form className={styles.formShare}>
      ...
      <div className={styles.boxEndForm}>
        ...
        <textarea name="" id="" cols="60" rows="10" value={textareaContent} onChange={(e) => setTextareaContent(e.target.value)} style={{height: 400, padding: 10}}></textarea>
      </div>
      <button type="button" onClick={handleShare}>Compartir</button>
    </form>
  );
};
